...
events. Upon receiving an event it's dispatched to a user provided function which will be retried until successful, failures are re-offered with an incremental back-off period. 
